...
namespace Aseguranza.Clases
{
    public class Localidad
    {
        ...
        public static DataTable ConsultarLocalidades(string textoBuscar)
        {
            ...
            conexion.Open();
            SqlCommand command = new SqlCommand("spConsultarLocalidades", conexion);
        ...
        public static Clases.Mensaje BorrarLocalidad(int id)
        {
            Clases.Mensaje respuesta = new Clases.Mensaje();
            SqlConnection conexion = Conexion.Conectar();
            SqlCommand command = new SqlCommand("spBorrarLocalidad", conexion);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public Clases.Mensaje GuardarLocalidad()
        {
            Clases.Mensaje respuesta = new Clases.Mensaje();
            SqlConnection conexion = Conexion.Conectar();
            SqlCommand command = new SqlCommand("spGuardarLocalidad", conexion);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue("@Id", Id);
